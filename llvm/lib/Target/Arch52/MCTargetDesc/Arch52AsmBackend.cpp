...
namespace {
class Arch52AsmBackend : public MCAsmBackend {
protected:
  const Target &TheTarget;

public:
  Arch52AsmBackend(const Target &T)
...
class ELFArch52AsmBackend : public Arch52AsmBackend {
  Triple::OSType OSType;

public:
  ELFArch52AsmBackend(const Target &T, Triple::OSType OSType)
      : Arch52AsmBackend(T), OSType(OSType) {}
